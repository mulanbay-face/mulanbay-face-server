package cn.mulanbay.face.spider.thread;
...
import cn.mulanbay.face.spider.handler.LogHandler;
import cn.mulanbay.face.spider.handler.SystemConfigHandler;
...
public class OperationLogThread extends BaseLogThread {
    ...
    private void addParaNotFoundSystemLog(OperationLog log) {
        ...
        systemLog.setErrorCode(SpiderErrorCode.OPERATION_LOG_PARA_IS_NULL);
