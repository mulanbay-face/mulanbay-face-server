...
public class QuartzSource {
    ...
    /**
     * 自动重做的任务最大的支持条数，默认只做7天以内的
     */
    private int autoRedoTaskDays=7;
    ...
    public int getAutoRedoTaskDays() {
        return autoRedoTaskDays;
    }

    public void setAutoRedoTaskDays(int autoRedoTaskDays) {
        this.autoRedoTaskDays = autoRedoTaskDays;
    }
