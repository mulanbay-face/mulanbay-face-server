package cn.mulanbay.face.api.web.aop;
...
public class ControllerHandler {
     ...
     */
    @Pointcut("execution(public * cn.mulanbay.face.api.web.controller.*.*(..))")
    ...
    public void beforeBuss(JoinPoint joinPoint) {
        try {
            ...
            if (sf == null) {
                ...
                throw new ApplicationException(ApiErrorCode.SYSTEM_FUNCTION_DISABLED);
            }
            LoginUser loginUser = tokenHandler.getLoginUser(request, true);
            if (sf.getLoginAuth()) {
                if (loginUser == null) {
