...
import cn.mulanbay.business.enums.IdFieldType;
import cn.mulanbay.business.enums.LogCompareType;
import cn.mulanbay.common.exception.ApplicationException;
import cn.mulanbay.common.exception.ErrorCode;
import cn.mulanbay.common.util.JsonUtil;
import cn.mulanbay.common.util.StringUtil;
import cn.mulanbay.face.api.common.ApiErrorCode;
import cn.mulanbay.face.api.persistent.dto.OperationLogDateStat;
import cn.mulanbay.face.api.persistent.dto.OperationLogStat;
import cn.mulanbay.face.api.persistent.dto.OperationLogTreeStat;
import cn.mulanbay.face.api.persistent.service.AuthService;
import cn.mulanbay.face.api.persistent.service.LogService;
import cn.mulanbay.face.api.util.ChartUtil;
import cn.mulanbay.face.api.web.bean.request.log.*;
import cn.mulanbay.face.api.web.bean.response.chart.*;
import cn.mulanbay.face.api.web.bean.response.log.OperationBeanDetailResponse;
import cn.mulanbay.face.api.web.bean.response.log.OperationLogCompareResponse;
...
public class OperationLogController extends BaseController {
    ...
    public ResultBean getBeanDetail(Long id) {
        ...
        if (StringUtil.isEmpty(idValue)) {
            throw new ApplicationException(ApiErrorCode.OPERATION_LOG_BEAN_ID_NULL);
        } else {
    ...
    public ResultBean getEditLogData(@Valid OperationLogGetEditRequest gr) {
        ...
        if (sf == null) {
            throw new ApplicationException(ApiErrorCode.SYSTEM_FUNCTION_NOT_DEFINE, gr.getBeanName() + "修改类功能点没有定义");
        }
        //获取业务表最新的数据
    ...
    public ResultBean getNearstCompareData(Long currentCompareId, LogCompareType compareType) {
        ...
        if (StringUtil.isEmpty(currentCompareLog.getIdValue())) {
            //idValue无法比较
            throw new ApplicationException(ApiErrorCode.OPERATION_LOG_COMPARE_ID_VALUE_NULL);
        }
