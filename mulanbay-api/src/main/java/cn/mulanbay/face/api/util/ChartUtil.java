package cn.mulanbay.face.api.util;
...
import cn.mulanbay.face.api.web.bean.request.DateStatSearch;
import cn.mulanbay.face.api.web.bean.response.chart.ChartCalendarData;
...
public class ChartUtil {
    ...
    public static ChartCalendarData createChartCalendarData(String title, String legendOne, String unit, DateStatSearch sf, List list) {
        ...
        if (year != endYear) {
            throw new ApplicationException(ApiErrorCode.START_YEAR_NOT_EQUALS_END_YEAR);
        }
