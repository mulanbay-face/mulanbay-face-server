...
import cn.mulanbay.face.api.persistent.dto.SystemLogAnalyseStat;
import cn.mulanbay.face.api.persistent.util.MysqlUtil;
import cn.mulanbay.face.api.web.bean.request.log.OperationLogDateStatSearch;
import cn.mulanbay.face.api.web.bean.request.log.OperationLogStatSearch;
import cn.mulanbay.face.api.web.bean.request.log.OperationLogTreeStatSearch;
import cn.mulanbay.face.api.web.bean.request.log.SystemLogAnalyseStatSearch;
    ...
    public List<SystemLogAnalyseStat> analyseStatDateOperationLog(SystemLogAnalyseStatSearch sf) {
        try {
            ...
            for(SystemLogAnalyseStat as : list){
                if(as.getId()==null){
                    as.setName("未知");
                }else if(groupField.equals("exception_class_name")||groupField.equals("error_code")){
                    as.setName(as.getId().toString());
                }else if(groupField.equals("log_level")){
