...
import cn.mulanbay.business.domain.Role;
...
import cn.mulanbay.face.api.web.bean.request.auth.RoleFormRequest;
import cn.mulanbay.face.api.web.bean.request.auth.RoleFunctionRequest;
import cn.mulanbay.face.api.web.bean.request.auth.RoleSearch;
import cn.mulanbay.face.api.web.bean.request.auth.UserRoleRequest;
import cn.mulanbay.face.api.web.bean.request.user.RoleFunctionTreeRequest;
