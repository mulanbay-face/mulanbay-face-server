...
import cn.mulanbay.business.domain.City;
...
import cn.mulanbay.face.api.web.bean.request.auth.SystemFunctionFormRequest;
import cn.mulanbay.face.api.web.bean.request.auth.SystemFunctionSearch;
import cn.mulanbay.face.api.web.bean.request.auth.SystemFunctionTreeRequest;
...
public class SystemFunctionController extends BaseController {
    ...
    public ResultBean getDomainClassNamesTree(Boolean needRoot) {
        List<TreeBean> treeBeans = new ArrayList<>();
        String packageName1 = City.class.getPackage().getName();
