...
import cn.mulanbay.face.api.handler.bean.MessageContent;
import cn.mulanbay.face.api.handler.bean.WxAccessToken;
...
import cn.mulanbay.face.api.web.bean.response.wechat.WxJsApiTicketVo;
...
public class WxpayHandler extends BaseHandler {
    ...
    public WxJsApiTicketVo getJsapiTicket(String accessToken) {
        ...
        if (hr.getStatusCode() == HttpStatus.SC_OK) {
            ...
            throw new ApplicationException(ApiErrorCode.WXPAY_JSAPITOCKEN_ERROR);
        }
    }
    ...
    public String getSha1(String str) {
        try {
            ...
            throw new ApplicationException(ApiErrorCode.WXPAY_TOKEN_SHA_ERROR);
        }
    }
